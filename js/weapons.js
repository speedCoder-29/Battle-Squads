...
const Weapons = (() => {
  ...
  const RAW = [
    ...
    ['Vector','SMG','7.5',26.3,'18, 25, 33','1.6s',3.97,0.1,'0.15s',2,8,'Yellow','Automatic','20%','None','Suppressor','HP, Tracer','Assault','Rc,S,H','Rd,A,W','F,M,D',880,46,'Absurd rate of fire, evaporates past a room',4.5],
