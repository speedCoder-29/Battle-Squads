...
const Weapons = (() => {
  ...
  const RAW = [
    ...
    ['M870','Shotgun','12.5',1.11,'5','0.75s/shell',8,2.1,'0.3s',5,8,'Red','Non-Automatic','10%','9 Pellets','Sawed-Off, Scope','Slug, Birdshot','Breacher','D,H,W','Rd,S,Rc','F,M,A',40,13,'A full 9-pellet hit at contact range kills outright',2],
    ['BM4','Shotgun','9.5',2.2,'8','0.52s/shell',5,1.75,'0.5s',4,10,'Red','Semi-Automatic','7%','9 Pellets','Sawed-Off, Scope','Slug, Birdshot','Breacher','Rd,A,S','F,M,W','D,H,Rc',46,18,'Flechette loads: the shotgun that still works at range',4],
    ['SPAS-12','Shotgun','11.5',1.33,'9','0.55s/shell',5.5,1.4,'0.4s',6,12,'Red','Semi-Automatic','5%','9 Pellets','Sawed-Off, Scope','Slug, Birdshot','Breacher','F,M,Rc','D,A,H','Rd,S,W',42,15,'Semi-auto buckshot - two triggers, two bodies',3],
